...
## 🚫 Blocked
- ❌ [docker-monitor:container-stopped] Container `brian-mcp-memory` is not running on the NAS — check `docker logs brian-mcp-memory` and restart — 2026-06-30 08:00 UTC
